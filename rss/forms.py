...
class ContactForm(forms.Form):
    ...
    forbidden_words = ['seo', 'ranking','https://', 'www', '.com', '.uk','.org' 'whitehat', 'ranks','hacked','Bitcoin', 'compromised', 'organically','keywords','baclink', 'toxic', 'profile', 'toxicity','Stacking','comprehensive','metrics']
